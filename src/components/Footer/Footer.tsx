    ...
    <div className="flex justify-between">
        ...
        <div className="flex space-x-6 sm:justify-end sm:mt-0">
            <a href="#" className="flex items-center justify-center">
                <FontAwesomeIcon icon={faInstagram} className="w-7 h-9 hover:text-[#57009C] focus:text-[#57009C]" />
            </a>
            <a href="#" className="flex items-center justify-center">
                <FontAwesomeIcon icon={faFacebookF} className="w-7 h-7 hover:text-[#57009C] focus:text-[#57009C]" />
            </a>
        </div>
    </div>
    <span className="text-gray-500  dark:text-gray-400">
