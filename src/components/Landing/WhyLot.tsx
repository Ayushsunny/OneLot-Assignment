...
export default function WhyLot() {
  return (
    <div className="bg-white text-center px-4 py-20 border-t border-b md:px-16 md:py-28">
      <p className="text-4xl font-extrabold mb-16 md:text-5xl md:mb-20">
        Why Onelot?
      </p>
      <div className="grid grid-cols-1 gap-6 md:flex md:flex-row md:justify-center md:items-center">
        {/* First Card */}
        <div className="bg-white shadow-md flex flex-col items-center border border-gray-200 rounded-lg overflow-hidden w-full h-auto md:w-80 md:h-80">
          <div className="flex h-full flex-col justify-center gap-4 p-6 md:p-8">
            ...
            <div className="flex flex-col justify-center items-center p-0 h-2/3 overflow-hidden w-full">
              <p className="text-xl font-semibold mx-4 text-black text-center mb-6 w-full">
                Trust
              </p>
              <p className="text-lg text-gray-500 text-center overflow-hidden">
